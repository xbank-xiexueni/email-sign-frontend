...
const App = () => {
  ...
  console.log('🚀 ~ file: App.tsx:139 ~ App ~ contentHeight:', contentHeight);
              ...
              <div>
                  ...
                  >
                    ...
                    >
                      <rect
                        ...
                        rx='2'
                        fill={
                          tabKey === TAB_KEY.MINNOCOS ? '#A30101' : '#737373'
                        }
                      />
                      <path
                ...
                >
                  ...
                  >
                    ...
                    {/* 手机号 */}
                    <Form.Item name={'phone'} style={{ marginBottom: '20px' }}>
          ...
          >
            ...
            <div style={{ marginTop: '46px', padding: '0 88px' }}>
              ...
              >
                ...
                <span style={{ fontWeight: 500 }}> 添加个性签名；</span>
              </p>
              <p
                style={{
                  color: '#737373',
              ...
              >
                ...
                <span style={{ fontWeight: 500 }}> 保存按钮；</span>
              </p>
              <p
                style={{
                  color: '#737373',
